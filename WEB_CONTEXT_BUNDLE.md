...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-60000-the-double-cap-conjecture-f0978bb3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-60000"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-60000-the-double-cap-conjecture-f0978bb3-v1",
      "problem_contract_sha256": "12325612a7544a496ccb67d1ada4517fee306a426ed7f8d51b546790549017e3",
      "problem_id": "problem:um-opg-60000-the-double-cap-conjecture-f0978bb3",
      "route_id": "route:um-opg-60000-the-double-cap-conjecture-f0978bb3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-60000-the-double-cap-conjecture-f0978bb3-source-fidelity-01",
      "graph_id": "graph:um-opg-60000-the-double-cap-conjecture-f0978bb3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-60000-the-double-cap-conjecture-f0978bb3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-60000-the-double-cap-conjecture-f0978bb3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture The largest measure of a Lebesgue measurable subset of the unit sphere of $\\mathbb{R}^n$ containing no pair of orthogonal vectors is attained by two open caps of geodesic radius $\\pi/4$ around the north and south poles."
          },
          "statement_sha256": "955b1f1af2dc254b9e0867e8793df077d8152bb1599156bd28a300525202924f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-60000-the-double-cap-conjecture-f0978bb3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-60000-the-double-cap-conjecture-f0978bb3-root",
      "route_id": "route:um-opg-60000-the-double-cap-conjecture-f0978bb3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-60000-3e2ad185bd6c",
        "url": "https://www.unsolvedmath.com/problems/OPG-60000"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
